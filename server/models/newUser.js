...
NewUserSchema.methods.getSignedJwtToken = function () {
...
NewUserSchema.methods.matchPassword = async function (enteredPassword) {
  return await bcrypt.compare(enteredPassword, this.password);
};

NewUserSchema.methods.getResetPasswordToken = function () {
